USE [ACKAppDB]
GO
/****** Object:  UserDefinedFunction [dbo].[MONTAJ_EKIP_ID_LISTESI]    Script Date: 12/01/2014 16:47:14 ******/
...
GO
/****** Object:  UserDefinedFunction [dbo].[MONTAJ_EKIP_LISTESI]    Script Date: 12/01/2014 16:47:14 ******/
...
GO
/****** Object:  Table [dbo].[MONTAJ_PERSONEL]    Script Date: 12/01/2014 16:47:10 ******/
...
GO
/****** Object:  Table [dbo].[PERSONELBILGI]    Script Date: 12/01/2014 16:47:10 ******/
...
GO
/****** Object:  Table [dbo].[REF_AKSESUARRENK]    Script Date: 12/01/2014 16:47:10 ******/
...
GO
/****** Object:  Table [dbo].[REF_ALUMINYUMRENK]    Script Date: 12/01/2014 16:47:10 ******/
...
GO
/****** Object:  Table [dbo].[REF_BARELTIP]    Script Date: 12/01/2014 16:47:10 ******/
...
GO
/****** Object:  Table [dbo].[REF_CEKMEKOLU]    Script Date: 12/01/2014 16:47:10 ******/
...
GO
/****** Object:  Table [dbo].[REF_CITA]    Script Date: 12/01/2014 16:47:10 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[REF_CITA]') AND type in (N'U'))
DROP TABLE [dbo].[REF_CITA]
GO
/****** Object:  Table [dbo].[REF_CONTARENK]    Script Date: 12/01/2014 16:47:11 ******/
...
GO
/****** Object:  Table [dbo].[REF_KAPIRENK]    Script Date: 12/01/2014 16:47:11 ******/
...
GO
/****** Object:  Table [dbo].[REF_KAPISERI]    Script Date: 12/01/2014 16:47:11 ******/
...
GO
/****** Object:  Table [dbo].[REF_KILITSISTEM]    Script Date: 12/01/2014 16:47:11 ******/
...
GO
/****** Object:  Table [dbo].[REF_MONTAJSEKLI]    Script Date: 12/01/2014 16:47:11 ******/
...
GO
/****** Object:  Table [dbo].[REF_PERVAZTIP]    Script Date: 12/01/2014 16:47:11 ******/
...
GO
/****** Object:  Table [dbo].[REF_TABLOLAR]    Script Date: 12/01/2014 16:47:11 ******/
...
GO
/****** Object:  Table [dbo].[REF_TACTIP]    Script Date: 12/01/2014 16:47:11 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[REF_TACTIP]') AND type in (N'U'))
DROP TABLE [dbo].[REF_TACTIP]
GO
/****** Object:  Table [dbo].[REF_TESLIMSEKLI]    Script Date: 12/01/2014 16:47:12 ******/
...
GO
/****** Object:  Table [dbo].[SIPARIS]    Script Date: 12/01/2014 16:47:12 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[SIPARIS]') AND type in (N'U'))
DROP TABLE [dbo].[SIPARIS]
GO
/****** Object:  Table [dbo].[SIPARISNOSAYAC]    Script Date: 12/01/2014 16:47:12 ******/
...
GO
/****** Object:  Table [dbo].[HATA]    Script Date: 12/01/2014 16:47:10 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[HATA]') AND type in (N'U'))
DROP TABLE [dbo].[HATA]
GO
/****** Object:  Table [dbo].[KULLANICIBILGI]    Script Date: 12/01/2014 16:47:10 ******/
...
GO
/****** Object:  Table [dbo].[MONTAJ]    Script Date: 12/01/2014 16:47:10 ******/
...
INSERT [dbo].[MONTAJ] ([ID], [SIPARISNO], [TESLIMTARIH], [PERSONELLISTEID], [DURUM]) VALUES (1, N'N-9', CAST(0x0000A3E200000000 AS DateTime), NULL, N'A')
INSERT [dbo].[MONTAJ] ([ID], [SIPARISNO], [TESLIMTARIH], [PERSONELLISTEID], [DURUM]) VALUES (2, N'K-3', CAST(0x0000A3E200000000 AS DateTime), NULL, N'K')
...
INSERT [dbo].[HATA] ([ID], [MODULEID], [EVENTLOGENTRYTYPEID], [EXCEPTION], [PAGEURL], [METHODNAME], [MESSAGE], [USERIDENTITY], [PCNAME], [USERAUTHORITY], [EXTENDEDPROPERTIES], [USERNAME], [DATE]) VALUES (1042, 0, 1, N'Message: Exception of type ''System.Web.HttpUnhandledException'' was thrown. StackTrace:    at System.Web.UI.Page.HandleError(Exception e)
   at System.Web.UI.Page.ProcessRequestMain(Boolean includeStagesBeforeAsyncPoint, Boolean includeStagesAfterAsyncPoint)
   at System.Web.UI.Page.ProcessRequest(Boolean includeStagesBeforeAsyncPoint, Boolean includeStagesAfterAsyncPoint)
   at System.Web.UI.Page.ProcessRequest()
   at System.Web.UI.Page.ProcessRequestWithNoAssert(HttpContext context)
   at System.Web.UI.Page.ProcessRequest(HttpContext context)
   at ASP.istakvimi_aspx.ProcessRequest(HttpContext context) in c:\Users\ibrhmoguz\AppData\Local\Temp\Temporary ASP.NET Files\root\d7e34744\13ad272a\App_Web_01nvlmws.3.cs:line 0
   at System.Web.HttpApplication.CallHandlerExecutionStep.System.Web.HttpApplication.IExecutionStep.Execute()
   at System.Web.HttpApplication.ExecuteStep(IExecutionStep step, Boolean& completedSynchronously) Source: System.WebInner Exception Message: Exception of type ''System.Web.HttpUnhandledException'' was thrown. StackTrace:    at System.Web.UI.Page.HandleError(Exception e)
   at System.Web.UI.Page.ProcessRequestMain(Boolean includeStagesBeforeAsyncPoint, Boolean includeStagesAfterAsyncPoint)
   at System.Web.UI.Page.ProcessRequest(Boolean includeStagesBeforeAsyncPoint, Boolean includeStagesAfterAsyncPoint)
   ...
   at ASP.istakvimi_aspx.ProcessRequest(HttpContext context) in c:\Users\ibrhmoguz\AppData\Local\Temp\Temporary ASP.NET Files\root\d7e34744\13ad272a\App_Web_01nvlmws.3.cs:line 0
   at System.Web.HttpApplication.CallHandlerExecutionStep.System.Web.HttpApplication.IExecutionStep.Execute()
   at System.Web.HttpApplication.ExecuteStep(IExecutionStep step, Boolean& completedSynchronously) Source: System.Web', N'', N'', N'', N'', N'', N'', N'', N'', CAST(0x0000A3F1016A35C6 AS DateTime))
INSERT [dbo].[HATA] ([ID], [MODULEID], [EVENTLOGENTRYTYPEID], [EXCEPTION], [PAGEURL], [METHODNAME], [MESSAGE], [USERIDENTITY], [PCNAME], [USERAUTHORITY], [EXTENDEDPROPERTIES], [USERNAME], [DATE]) VALUES (1043, 0, 1, N'Message: Exception of type ''System.Web.HttpUnhandledException'' was thrown. StackTrace:    at System.Web.UI.Page.HandleError(Exception e)
   at System.Web.UI.Page.ProcessRequestMain(Boolean includeStagesBeforeAsyncPoint, Boolean includeStagesAfterAsyncPoint)
   at System.Web.UI.Page.ProcessRequest(Boolean includeStagesBeforeAsyncPoint, Boolean includeStagesAfterAsyncPoint)
   at System.Web.UI.Page.ProcessRequest()
   at System.Web.UI.Page.ProcessRequestWithNoAssert(HttpContext context)
   ...
   at ASP.istakvimi_aspx.ProcessRequest(HttpContext context) in c:\Users\ibrhmoguz\AppData\Local\Temp\Temporary ASP.NET Files\root\d7e34744\13ad272a\App_Web_01nvlmws.3.cs:line 0
   at System.Web.HttpApplication.CallHandlerExecutionStep.System.Web.HttpApplication.IExecutionStep.Execute()
   at System.Web.HttpApplication.ExecuteStep(IExecutionStep step, Boolean& completedSynchronously) Source: System.Web', N'', N'', N'', N'', N'', N'', N'', N'', CAST(0x0000A3F1016AC6E0 AS DateTime))
INSERT [dbo].[HATA] ([ID], [MODULEID], [EVENTLOGENTRYTYPEID], [EXCEPTION], [PAGEURL], [METHODNAME], [MESSAGE], [USERIDENTITY], [PCNAME], [USERAUTHORITY], [EXTENDEDPROPERTIES], [USERNAME], [DATE]) VALUES (1044, 0, 1, N'Message: Exception of type ''System.Web.HttpUnhandledException'' was thrown. StackTrace:    at System.Web.UI.Page.HandleError(Exception e)
   at System.Web.UI.Page.ProcessRequestMain(Boolean includeStagesBeforeAsyncPoint, Boolean includeStagesAfterAsyncPoint)
   at System.Web.UI.Page.ProcessRequest(Boolean includeStagesBeforeAsyncPoint, Boolean includeStagesAfterAsyncPoint)
   at System.Web.UI.Page.ProcessRequest()
   at System.Web.UI.Page.ProcessRequestWithNoAssert(HttpContext context)
   at System.Web.UI.Page.ProcessRequest(HttpContext context)
   at ASP.siparisformguncelle_aspx.ProcessRequest(HttpContext context) in c:\Users\ibrhmoguz\AppData\Local\Temp\Temporary ASP.NET Files\root\d7e34744\13ad272a\App_Web_tp2kj5cw.1.cs:line 0
   at System.Web.HttpApplication.CallHandlerExecutionStep.System.Web.HttpApplication.IExecutionStep.Execute()
   at System.Web.HttpApplication.ExecuteStep(IExecutionStep step, Boolean& completedSynchronously) Source: System.WebInner Exception Message: Exception of type ''System.Web.HttpUnhandledException'' was thrown. StackTrace:    at System.Web.UI.Page.HandleError(Exception e)
   at System.Web.UI.Page.ProcessRequestMain(Boolean includeStagesBeforeAsyncPoint, Boolean includeStagesAfterAsyncPoint)
   at System.Web.UI.Page.ProcessRequest(Boolean includeStagesBeforeAsyncPoint, Boolean includeStagesAfterAsyncPoint)
   ...
   at ASP.siparisformguncelle_aspx.ProcessRequest(HttpContext context) in c:\Users\ibrhmoguz\AppData\Local\Temp\Temporary ASP.NET Files\root\d7e34744\13ad272a\App_Web_tp2kj5cw.1.cs:line 0
   at System.Web.HttpApplication.CallHandlerExecutionStep.System.Web.HttpApplication.IExecutionStep.Execute()
   at System.Web.HttpApplication.ExecuteStep(IExecutionStep step, Boolean& completedSynchronously) Source: System.Web', N'', N'', N'', N'', N'', N'', N'', N'', CAST(0x0000A3F10176F9D4 AS DateTime))
INSERT [dbo].[HATA] ([ID], [MODULEID], [EVENTLOGENTRYTYPEID], [EXCEPTION], [PAGEURL], [METHODNAME], [MESSAGE], [USERIDENTITY], [PCNAME], [USERAUTHORITY], [EXTENDEDPROPERTIES], [USERNAME], [DATE]) VALUES (1045, 0, 1, N'Message: Exception of type ''System.Web.HttpUnhandledException'' was thrown. StackTrace:    at System.Web.UI.Page.HandleError(Exception e)
   at System.Web.UI.Page.ProcessRequestMain(Boolean includeStagesBeforeAsyncPoint, Boolean includeStagesAfterAsyncPoint)
   at System.Web.UI.Page.ProcessRequest(Boolean includeStagesBeforeAsyncPoint, Boolean includeStagesAfterAsyncPoint)
   at System.Web.UI.Page.ProcessRequest()
   at System.Web.UI.Page.ProcessRequestWithNoAssert(HttpContext context)
   at System.Web.UI.Page.ProcessRequest(HttpContext context)
   at ASP.siparisformgoruntule_aspx.ProcessRequest(HttpContext context) in c:\Users\ibrhmoguz\AppData\Local\Temp\Temporary ASP.NET Files\root\d7e34744\13ad272a\App_Web_o1bvoamt.7.cs:line 0
   at System.Web.HttpApplication.CallHandlerExecutionStep.System.Web.HttpApplication.IExecutionStep.Execute()
   at System.Web.HttpApplication.ExecuteStep(IExecutionStep step, Boolean& completedSynchronously) Source: System.WebInner Exception Message: Exception of type ''System.Web.HttpUnhandledException'' was thrown. StackTrace:    at System.Web.UI.Page.HandleError(Exception e)
   at System.Web.UI.Page.ProcessRequestMain(Boolean includeStagesBeforeAsyncPoint, Boolean includeStagesAfterAsyncPoint)
   at System.Web.UI.Page.ProcessRequest(Boolean includeStagesBeforeAsyncPoint, Boolean includeStagesAfterAsyncPoint)
   ...
   at ASP.siparisformgoruntule_aspx.ProcessRequest(HttpContext context) in c:\Users\ibrhmoguz\AppData\Local\Temp\Temporary ASP.NET Files\root\d7e34744\13ad272a\App_Web_o1bvoamt.7.cs:line 0
   at System.Web.HttpApplication.CallHandlerExecutionStep.System.Web.HttpApplication.IExecutionStep.Execute()
   at System.Web.HttpApplication.ExecuteStep(IExecutionStep step, Boolean& completedSynchronously) Source: System.Web', N'', N'', N'', N'', N'', N'', N'', N'', CAST(0x0000A3F10178044C AS DateTime))
INSERT [dbo].[HATA] ([ID], [MODULEID], [EVENTLOGENTRYTYPEID], [EXCEPTION], [PAGEURL], [METHODNAME], [MESSAGE], [USERIDENTITY], [PCNAME], [USERAUTHORITY], [EXTENDEDPROPERTIES], [USERNAME], [DATE]) VALUES (1046, 0, 1, N'Message: Exception of type ''System.Web.HttpUnhandledException'' was thrown. StackTrace:    at System.Web.UI.Page.HandleError(Exception e)
   at System.Web.UI.Page.ProcessRequestMain(Boolean includeStagesBeforeAsyncPoint, Boolean includeStagesAfterAsyncPoint)
   at System.Web.UI.Page.ProcessRequest(Boolean includeStagesBeforeAsyncPoint, Boolean includeStagesAfterAsyncPoint)
   at System.Web.UI.Page.ProcessRequest()
   at System.Web.UI.Page.ProcessRequestWithNoAssert(HttpContext context)
   ...
   at ASP.siparisformgoruntule_aspx.ProcessRequest(HttpContext context) in c:\Users\ibrhmoguz\AppData\Local\Temp\Temporary ASP.NET Files\root\d7e34744\13ad272a\App_Web_o1bvoamt.7.cs:line 0
   at System.Web.HttpApplication.CallHandlerExecutionStep.System.Web.HttpApplication.IExecutionStep.Execute()
   at System.Web.HttpApplication.ExecuteStep(IExecutionStep step, Boolean& completedSynchronously) Source: System.Web', N'', N'', N'', N'', N'', N'', N'', N'', CAST(0x0000A3F101782194 AS DateTime))
INSERT [dbo].[HATA] ([ID], [MODULEID], [EVENTLOGENTRYTYPEID], [EXCEPTION], [PAGEURL], [METHODNAME], [MESSAGE], [USERIDENTITY], [PCNAME], [USERAUTHORITY], [EXTENDEDPROPERTIES], [USERNAME], [DATE]) VALUES (1047, 0, 1, N'Message: Exception of type ''System.Web.HttpUnhandledException'' was thrown. StackTrace:    at System.Web.UI.Page.HandleError(Exception e)
   at System.Web.UI.Page.ProcessRequestMain(Boolean includeStagesBeforeAsyncPoint, Boolean includeStagesAfterAsyncPoint)
   at System.Web.UI.Page.ProcessRequest(Boolean includeStagesBeforeAsyncPoint, Boolean includeStagesAfterAsyncPoint)
   at System.Web.UI.Page.ProcessRequest()
   at System.Web.UI.Page.ProcessRequestWithNoAssert(HttpContext context)
   at System.Web.UI.Page.ProcessRequest(HttpContext context)
   at ASP.siparisformguncelle_aspx.ProcessRequest(HttpContext context) in c:\Users\ibrhmoguz\AppData\Local\Temp\Temporary ASP.NET Files\root\d7e34744\13ad272a\App_Web_wc3iox0h.2.cs:line 0
   at System.Web.HttpApplication.CallHandlerExecutionStep.System.Web.HttpApplication.IExecutionStep.Execute()
   at System.Web.HttpApplication.ExecuteStep(IExecutionStep step, Boolean& completedSynchronously) Source: System.WebInner Exception Message: Exception of type ''System.Web.HttpUnhandledException'' was thrown. StackTrace:    at System.Web.UI.Page.HandleError(Exception e)
   at System.Web.UI.Page.ProcessRequestMain(Boolean includeStagesBeforeAsyncPoint, Boolean includeStagesAfterAsyncPoint)
   at System.Web.UI.Page.ProcessRequest(Boolean includeStagesBeforeAsyncPoint, Boolean includeStagesAfterAsyncPoint)
   ...
   at ASP.siparisformguncelle_aspx.ProcessRequest(HttpContext context) in c:\Users\ibrhmoguz\AppData\Local\Temp\Temporary ASP.NET Files\root\d7e34744\13ad272a\App_Web_wc3iox0h.2.cs:line 0
   at System.Web.HttpApplication.CallHandlerExecutionStep.System.Web.HttpApplication.IExecutionStep.Execute()
   at System.Web.HttpApplication.ExecuteStep(IExecutionStep step, Boolean& completedSynchronously) Source: System.Web', N'', N'', N'', N'', N'', N'', N'', N'', CAST(0x0000A3F10178874F AS DateTime))
INSERT [dbo].[HATA] ([ID], [MODULEID], [EVENTLOGENTRYTYPEID], [EXCEPTION], [PAGEURL], [METHODNAME], [MESSAGE], [USERIDENTITY], [PCNAME], [USERAUTHORITY], [EXTENDEDPROPERTIES], [USERNAME], [DATE]) VALUES (1048, 0, 1, N'Message: Exception of type ''System.Web.HttpUnhandledException'' was thrown. StackTrace:    at System.Web.UI.Page.HandleError(Exception e)
   at System.Web.UI.Page.ProcessRequestMain(Boolean includeStagesBeforeAsyncPoint, Boolean includeStagesAfterAsyncPoint)
   at System.Web.UI.Page.ProcessRequest(Boolean includeStagesBeforeAsyncPoint, Boolean includeStagesAfterAsyncPoint)
   at System.Web.UI.Page.ProcessRequest()
   at System.Web.UI.Page.ProcessRequestWithNoAssert(HttpContext context)
   ...
   at ASP.siparisformguncelle_aspx.ProcessRequest(HttpContext context) in c:\Users\ibrhmoguz\AppData\Local\Temp\Temporary ASP.NET Files\root\d7e34744\13ad272a\App_Web_wc3iox0h.2.cs:line 0
   at System.Web.HttpApplication.CallHandlerExecutionStep.System.Web.HttpApplication.IExecutionStep.Execute()
   at System.Web.HttpApplication.ExecuteStep(IExecutionStep step, Boolean& completedSynchronously) Source: System.Web', N'', N'', N'', N'', N'', N'', N'', N'', CAST(0x0000A3F10179039F AS DateTime))
...
INSERT [dbo].[SIPARIS] ([ID], [SIPARISNO], [SIPARISTARIH], [BAYIADI], [MUSTERIAD], [MUSTERISOYAD], [MUSTERIADRES], [MUSTERIIL], [MUSTERIILCE], [MUSTERIEVTEL], [MUSTERIISTEL], [MUSTERICEPTEL], [ICKAPIMODEL], [DISKAPIMODEL], [DISKAPIRENK], [ICKAPIRENK], [KILITSISTEM], [CITA], [ESIK], [ALUMINYUMRENK], [AKSESUARRENK], [CONTARENK], [TACTIP], [PERVAZTIP], [CEKMEKOLU], [KAPINO], [BARELTIP], [BABA], [DURBUN], [TAKTAK], [MONTAJDATAKILACAK], [OLCUMBILGI], [OLCUMTARIH], [OLCUMALANKISI], [MONTAJSEKLI], [TESLIMSEKLI], [PESINAT], [KALANODEME], [FIYAT], [VERGIDAIRESI], [VERGINUMARASI], [DURUM]) VALUES (1, N'N-9', CAST(0x0000A3A500282300 AS DateTime), N'asdfasdf', N'ibrahim', N'oguz', N'batikent', N'ANKARA', N'YENIMAHALLE', N'1111111111', N'2222222222', N'3333333333', N'101', N'102', N'Tik', N'Amerikan Ceviz', N'Kale 14''lü', N'H-Eloksal', N'Carmen Red', N'Seçiniz', N'Saten', N'Seçiniz', N'Seçiniz', N'Seçiniz', N'wer', N'9', N'qwe', N'Var', N'Var', N'Yok', N'asdfasdfasd', N'dfgsdfgsdf', CAST(0xF5380B00 AS Date), N'NEJLA GÜNER', N'Betonlu', N'Montajli', N'', N'', N'', N'', N'', N'TAMAMLANDI')
INSERT [dbo].[SIPARIS] ([ID], [SIPARISNO], [SIPARISTARIH], [BAYIADI], [MUSTERIAD], [MUSTERISOYAD], [MUSTERIADRES], [MUSTERIIL], [MUSTERIILCE], [MUSTERIEVTEL], [MUSTERIISTEL], [MUSTERICEPTEL], [ICKAPIMODEL], [DISKAPIMODEL], [DISKAPIRENK], [ICKAPIRENK], [KILITSISTEM], [CITA], [ESIK], [ALUMINYUMRENK], [AKSESUARRENK], [CONTARENK], [TACTIP], [PERVAZTIP], [CEKMEKOLU], [KAPINO], [BARELTIP], [BABA], [DURBUN], [TAKTAK], [MONTAJDATAKILACAK], [OLCUMBILGI], [OLCUMTARIH], [OLCUMALANKISI], [MONTAJSEKLI], [TESLIMSEKLI], [PESINAT], [KALANODEME], [FIYAT], [VERGIDAIRESI], [VERGINUMARASI], [DURUM]) VALUES (2, N'K-3', CAST(0x0000A3F200BE2463 AS DateTime), N'Bayi 1', N'Mustafa', N'TAS', N'Batikent', N'ANKARA', N'YENIMAHALLE', NULL, N'2222222222', N'3333333333', N'601', N'601', N'Karaagaç', N'Porte Ceviz', N'Kale 14''lü', N'H-Eloksal', N'Harmankaya', N'Seçiniz', N'Pirinç', N'Seçiniz', N'Seçiniz', N'Seçiniz', N'asd', N'9', N'dfgsdfgsd', N'Var', N'Var', N'Var', N'srgsdfgsdfg', N'safsdfasdfasdf', CAST(0xF8380B00 AS Date), N'NEJLA GÜNER', N'Vidali', N'Montajli', N'500', N'-1500
-1000', N'3000', N'KEÇIÖREN', N'123123123', N'BEKLEYEN')
INSERT [dbo].[SIPARIS] ([ID], [SIPARISNO], [SIPARISTARIH], [BAYIADI], [MUSTERIAD], [MUSTERISOYAD], [MUSTERIADRES], [MUSTERIIL], [MUSTERIILCE], [MUSTERIEVTEL], [MUSTERIISTEL], [MUSTERICEPTEL], [ICKAPIMODEL], [DISKAPIMODEL], [DISKAPIRENK], [ICKAPIRENK], [KILITSISTEM], [CITA], [ESIK], [ALUMINYUMRENK], [AKSESUARRENK], [CONTARENK], [TACTIP], [PERVAZTIP], [CEKMEKOLU], [KAPINO], [BARELTIP], [BABA], [DURBUN], [TAKTAK], [MONTAJDATAKILACAK], [OLCUMBILGI], [OLCUMTARIH], [OLCUMALANKISI], [MONTAJSEKLI], [TESLIMSEKLI], [PESINAT], [KALANODEME], [FIYAT], [VERGIDAIRESI], [VERGINUMARASI], [DURUM]) VALUES (3, N'N-10', CAST(0x0000A3AC00D8643B AS DateTime), N'Bayi 3', N'Ahmet', N'AYDIN', N'Batikent', N'ANKARA', N'YENIMAHALLE', N'1111111111', N'2222222222', N'3333333333', N'101', N'102', N'Karaagaç', N'Karaagaç', N'Kale 14''lü', N'H-Eloksal', N'Harmankaya', N'Seçiniz', N'Saten', N'Seçiniz', N'Seçiniz', N'Seçiniz', N'asd', N'8', N'sdfsd', N'Var', N'Yok', N'Var', N'werwerwe', N'dgdrtdtgdf', CAST(0xF6380B00 AS Date), N'DERIN GEÇMEZ', N'Vidali', N'Montajli', N'1000', N'-1000
-1000', N'3000', N'asdasd', N'45641231', N'ÝMALATTA')

...
{
    public partial class IlIlceyeGoreSatilanAdet : ACKBasePage
    {
        ...
        protected void btnSorgula_Click(object sender, EventArgs e)
        {
            ...
            GridDoldur(grdRaporIl, ds.Tables[0]);
            GridDoldur(grdRaporIlce, ds.Tables[1]);
            GridDoldur(grdRaporSemt, ds.Tables[2]);
        }
